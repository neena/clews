...
An EHR built on Ruby on Rails that can take a HL7 feed from a machine. This EWS is built to work with the Philips SureSigns VS2+ Vital Signs Monitor, but I'm working on testing it with other machines. 
